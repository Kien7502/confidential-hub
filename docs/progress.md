...
- Masked the dashboard total balance while any confidential balance remains undecrypted and restyled detail balances with Confidential and Standard status badges.
